...
PATH_TEST_DATA = os.path.join(PATH_DATA, "data_2023_10sec_h3_100km.csv")
...
PATH_TO_SAVE_DF = os.path.join(PATH_DATA, "testdata_2023_100km_comparable.csv")
PATH_TO_SAVE_NP = os.path.join(PATH_DATA, "testdata_2023_100km_comparable.npy")
